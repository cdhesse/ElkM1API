 ...
 *
 */
public class ElkRPConnected extends Message {

	private static final Map<String, String> STATUS = Collections
			.unmodifiableMap(new HashMap<String, String>() {
				{
					put("34", "M1XEP is initializing after powerup or reboot");
					put("36", "ELKRP disconnected broadcast");
					put("35", "ELKRP is connected, poll reply");
				}

			});
	
	public ElkRPConnected(String cmd, String fullCommand) {
		super(cmd, fullCommand);
	}

	public String toString() {
		return STATUS.get(message.substring(8, 10));
	}
}
